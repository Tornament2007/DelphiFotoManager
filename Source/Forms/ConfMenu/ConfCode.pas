...
begin
  ...
  MainForm.CCMO_AE   .Checked:=MainConfF.ReadBool('FileGridOptions','AutoCAE',False);
 // MainForm.CBLoadPrev.Checked:=MainConfF.ReadBool('FileGridOptions','FastPreView',True);
  ...
  SelectProg.PS_Path.Hint:=MainConfF.ReadString('EditorProg','PathTo','');
  SelectProg.PS_Path.Text:=SelectProg.PS_Path.Hint;
    SelectProg.PS_PathChange(SelectProg.PS_Path);
  SelectProg.PS_Name.Hint:=MainConfF.ReadString('EditorProg','Name','');
  SelectProg.PS_Name.Text:=SelectProg.PS_Name.Hint;
